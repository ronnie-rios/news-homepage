  ...
  return (
    <main className='grid grid-cols-1 md:grid-cols-3 gap-8'>
        ...
        <div className='row-span-2 p-6 bg-dark-blue'>
            <h1 className='text-5xl text-orange font-semibold'>New</h1>
            {news.map((item) => (
                <div className='py-8 border-b border-gray-blue'>
                    <h3 className='text-2xl font-semibold text-white pb-3'>{item.title}</h3>
        ...
        <div className='md:col-span-1 '>
            <p className='text-dark-blue mb-10'>We dive into the next evolution of the web that claims to put the power of the platform back into the hands of the people. but is it really fullfilling its promise?</p>
            <button className='bg-red py-3 px-8  text-white tracking-widest'>READ MORE</button>
        </div>
            {data.map((item) => (
                <div className='col-span-1 flex' key={item.id}>
                    ...
                    <div className=' px-4'>
                        ...
                        <h4 className='text-dark-blue text-xl font-bold py-2' >{item.title}</h4>
